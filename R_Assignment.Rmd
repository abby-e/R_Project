...
ggplot(fang_merged1,aes(x=as.numeric(Chromosome))) + geom_histogram(bins=10, aes(fill =as.character(Chromosome)))
...
new [new %in% c("A/A","T/T","C/C","G/G")] <- 1
new [new %in% c("A/G","A/T","C/G","C/T","G/T","A/C")] <- 0
new [new %in% c("?/?")] <-2
...
new2 [new2 %in% c("A/A","T/T","C/C","G/G")] <- 1
new2 [new2 %in% c("A/G","A/T","C/G","C/T","G/T","A/C")] <- 0
new2 [new2 %in% c("?/?")] <-2
